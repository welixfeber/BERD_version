...
{% block_2c(bg="grey" left_text="The Transatlantic Privacy Perceptions Project (TAPP) is a fully funded, independent research initiative that provides in-depth analysis of AI and digital privacy perceptions from experts in industry, law, NGOs, and academia across Europe and the USA.") %}We ([Team <img src="/tapp/assets/arrow_away.svg" class="inline-arrow">](@/people/index.md)) provide survey infrastructure and methodology knowledge to give experts opportunities to __raise awareness__ about the privacy issues they care about, thereby contributing to public debate and enhancing scientific research that can __improve policymaking and technological design__ ([DataViz <img src="/tapp/assets/arrow_away.svg" class="inline-arrow">](@/results/index.md) and [Findings <img src="/tapp/assets/arrow_away.svg" class="inline-arrow">](@/findings/index.md)).
